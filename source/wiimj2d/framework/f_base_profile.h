...
enum class fBaseProfile_e : u16 {
    ...
    // Actor 620, in the Nvidia Shield version, is replaced with three new actors. (620, 621, 622).
    // This shifts the rest of the table by 2 (not reflected here).
    LOGO_SCREEN = 620,
    NV_SCREEN = 621,
    ...
    // TIME_UP and later must be shifted up by two (e.g. TIME_UP is 704) when using the Korean
    // version or later.
