...
#include <d/d_game_common.h>
#include <d/d_scene.h>
#include <f/f_base_profile.h>
#include <m/m_pad.h>
...
/* 807A0DEC 981F0AFC */  stb      r0, 2812(r31);
/* 807A0DF0 38000000 */  li       r0, 0;
/* 807A0DF4 3C808035 */  lis      r4, UNDEF_8035000c@ha;
/* 807A0DF8 901E06A0 */  stw      r0, 1696(r30);
/* 807A0DFC 84045160 */  lwzu     r0, UNDEF_80355160@l(r4);
/* 807A0E00 901E06E0 */  stw      r0, 1760(r30);
/* 807A0E04 901E06F0 */  stw      r0, 1776(r30);
/* 807A0E08 801F0384 */  lwz      r0, 900(r31);
/* 807A0E0C 901E0690 */  stw      r0, 1680(r30);
/* 807A0E10 2C000003 */  cmpwi    r0, 3;
/* 807A0E14 40820010 */  bne-     UNDEF_807a0e24;
/* 807A0E18 807E06A0 */  lwz      r3, 1696(r30);
/* 807A0E1C 38030001 */  addi     r0, r3, 1;
/* 807A0E20 901E06A0 */  stw      r0, 1696(r30);
UNDEF_807a0e24:;
/* 807A0E24 80040004 */  lwz      r0, UNDEF_80350004@l(r4);
/* 807A0E28 901E06E4 */  stw      r0, 1764(r30);
/* 807A0E2C 901E06F4 */  stw      r0, 1780(r30);
/* 807A0E30 801F0388 */  lwz      r0, 904(r31);
/* 807A0E34 901E0694 */  stw      r0, 1684(r30);
/* 807A0E38 2C000003 */  cmpwi    r0, 3;
/* 807A0E3C 40820010 */  bne-     UNDEF_807a0e4c;
/* 807A0E40 807E06A0 */  lwz      r3, 1696(r30);
/* 807A0E44 38030001 */  addi     r0, r3, 1;
/* 807A0E48 901E06A0 */  stw      r0, 1696(r30);
UNDEF_807a0e4c:;
/* 807A0E4C 80040008 */  lwz      r0, UNDEF_80350008@l(r4);
/* 807A0E50 38BE0008 */  addi     r5, r30, 8;
/* 807A0E54 901E06E8 */  stw      r0, 1768(r30);
/* 807A0E58 38DF0008 */  addi     r6, r31, 8;
/* 807A0E5C 901E06F8 */  stw      r0, 1784(r30);
/* 807A0E60 801F038C */  lwz      r0, 908(r31);
/* 807A0E64 901E0698 */  stw      r0, 1688(r30);
/* 807A0E68 2C000003 */  cmpwi    r0, 3;
/* 807A0E6C 40820010 */  bne-     UNDEF_807a0e7c;
/* 807A0E70 807E06A0 */  lwz      r3, 1696(r30);
/* 807A0E74 38030001 */  addi     r0, r3, 1;
/* 807A0E78 901E06A0 */  stw      r0, 1696(r30);
UNDEF_807a0e7c:;
/* 807A0E7C 8004000C */  lwz      r0, UNDEF_8035000c@l(r4);
/* 807A0E80 900506E4 */  stw      r0, 1764(r5);
/* 807A0E84 900506F4 */  stw      r0, 1780(r5);
/* 807A0E88 80060388 */  lwz      r0, 904(r6);
/* 807A0E8C 90050694 */  stw      r0, 1684(r5);
/* 807A0E90 2C000003 */  cmpwi    r0, 3;
/* 807A0E94 40820010 */  bne-     UNDEF_807a0ea4;
/* 807A0E98 807E06A0 */  lwz      r3, 1696(r30);
/* 807A0E9C 38030001 */  addi     r0, r3, 1;
/* 807A0EA0 901E06A0 */  stw      r0, 1696(r30);
UNDEF_807a0ea4:;
/* 807A0EA4 7FC3F378 */  mr       r3, r30;
/* 807A0EA8 4BFFFB29 */  bl       UNDEF_807a09d0;
/* 807A0EAC 3C808035 */  lis      r4, UNDEF_80355160@ha;
...
/* 807A0EC0 38C00004 */  li       r6, 4;
/* 807A0EC4 7FC5F378 */  mr       r5, r30;
/* 807A0EC8 38845160 */  addi     r4, r4, UNDEF_80355160@l;
/* 807A0ECC 381E0690 */  addi     r0, r30, 1680;
/* 807A0ED0 393E06A0 */  addi     r9, r30, 1696;
/* 807A0ED4 38600001 */  li       r3, 1;
/* 807A0ED8 38E0FFFF */  li       r7, -1;
/* 807A0EDC 7CC903A6 */  mtctr    r6;
UNDEF_807a0ee0:;
/* 807A0EE0 80C50690 */  lwz      r6, 1680(r5);
...
/* 807A0EF8 80C6064C */  lwz      r6, 1612(r6);
/* 807A0EFC 98660261 */  stb      r3, 609(r6);
/* 807A0F00 C02600B0 */  lfs      f1, 176(r6);
/* 807A0F04 EC21102A */  fadds    f1, f1, f2;
/* 807A0F08 D02600B0 */  stfs     f1, 176(r6);
UNDEF_807a0f0c:;
...
/* 807A0F20 80C50074 */  lwz      r6, 116(r5);
/* 807A0F24 90060280 */  stw      r0, 640(r6);
/* 807A0F28 80C50074 */  lwz      r6, 116(r5);
/* 807A0F2C 81050084 */  lwz      r8, 132(r5);
/* 807A0F30 91060074 */  stw      r8, 116(r6);
/* 807A0F34 80C50074 */  lwz      r6, 116(r5);
/* 807A0F38 81050094 */  lwz      r8, 148(r5);
/* 807A0F3C 91060078 */  stw      r8, 120(r6);
/* 807A0F40 80C50074 */  lwz      r6, 116(r5);
...
/* 807A0F5C 811E06C4 */  lwz      r8, 1732(r30);
