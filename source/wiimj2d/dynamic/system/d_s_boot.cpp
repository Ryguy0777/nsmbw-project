...
#include <dynamic/bases/d_ControllerInformation.h>
#include <dynamic/bases/d_s_stage.h>
#include <dynamic/bases/d_s_world_map.h>
...
#include <dynamic/system/d_WiiStrap.h>
...
void dScBoot_c::executeState_ProcEnd()
{
    ...
    for (int i = 0; i < 8; i++) {
        ...
        if (i < 4) {
            dInfo_c::m_instance->mPlayerActiveMode[i] = 2;
        } else {
            dInfo_c::m_instance->mExPlayerActiveMode[i - 4] = 2;
        }
    }
