...
public:
    ...
    /* 0x801591F0 */
    bool Effect1Up(int textBoxIndex);
...
#define OFFSET_dGameDisplay_c_mPlayerRGBA0 0x5A4
    s16 mPlayerRGBA[4 + EXTRA_PLAYER_COUNT][4];

#define OFFSET_dGameDisplay_c_mPlayerRGBA1 0x5A4 + (4 + dGameDisplay_c_EXTRA_PLAYER_COUNT) * 0x10
    s16 mPlayerRGBA2[4 + EXTRA_PLAYER_COUNT][4];

#define OFFSET_dGameDisplay_c_mPlayerRGBA2 0x5A4 + (4 + dGameDisplay_c_EXTRA_PLAYER_COUNT) * 0x20
    s16 mPlayerRGBA3[4 + EXTRA_PLAYER_COUNT][4];
