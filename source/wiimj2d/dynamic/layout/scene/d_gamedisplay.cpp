...
// Changed the parameter from playerNo to textBoxIndex and added bool return
[[address(0x801591F0)]]
bool dGameDisplay_c::Effect1Up(int textBoxIndex) ASM_METHOD(
  // clang-format off
...
/* 8015920C 806DADA0 */  lwz      r3, -21088(r13);
...
/* 80159230 880DA942 */  lbz      r0, -22206(r13);
/* 80159234 2C000000 */  cmpwi    r0, 0;
/* 80159238 40820134 */  bne-     UNDEF_8015936c;
/* 8015923C 800DAB80 */  lwz      r0, -21632(r13);
...
/* 8015942C 3BCDAC90 */  subi     r30, r13, 21360;
...
/* 80159448 888DAC90 */  lbz      r4, -21360(r13);
...
/* 80159500 88ADAC90 */  lbz      r5, -21360(r13);
...
/* 801595A4 888DAC90 */  lbz      r4, -21360(r13);
...
void dGameDisplay_c::updatePlayNum(int* playNum)
{
    for (int i = 0; i < 4 + EXTRA_PLAYER_COUNT; i++) {
        ...
        if (newPlayNum > oldPlayNum && mEffectTimer[i] == 0) {
            mEffectTimer[i] = Effect1Up(PLAYER_TEXTBOX_INDEX[i]) ? 15 : 0;
        }
