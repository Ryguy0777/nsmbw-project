...
struct ResMatTexCoordGen : public ResCommon<ResTexCoordGenDL> {
    inline ResMatTexCoordGen(void* vptr)
      : ResCommon(vptr)
    {
    }
...
struct ResTexPlttInfo {
    ...
    inline ResTexPlttInfo(void* vptr)
      : mInfo(vptr)
    {
    }
};
